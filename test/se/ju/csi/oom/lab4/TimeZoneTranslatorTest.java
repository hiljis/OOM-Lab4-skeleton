...
public class TimeZoneTranslatorTest {
	...
	public void testShiftTimeZone() {
		DateTime cetDateTime = new DateTime(2018, 10, 2, 10, 0, 0);
		...
		assertEquals("2018-10-02 19:00:00", sydneyDateTime.toString());
	}

	@Test
	public void testShiftTimeZone2() {
		DateTime swedishTime = new DateTime(2016, 1, 1, 6, 0, 0);
		...
		assertEquals("2015-12-31 21:00:00", usPacificCoastTime.toString());
	}
	
	@Test
	public void testShiftTimeZone3() {
		DateTime usPacificCoastTime = new DateTime(2015, 12, 31, 21, 0, 0);
		...
		assertEquals("2016-01-01 06:00:00", swedishTime.toString());
	}
	...
	public void testShiftEventTimeZone() {
		...
		assertEquals("2018-08-27 17:00:00", newFirstOomLecture.getStartDate().toString());
		assertEquals("2018-08-27 18:45:00", newFirstOomLecture.getEndDate().toString());
	}
